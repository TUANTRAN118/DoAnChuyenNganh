        ...
        <div className='main mx-auto'>
            ...
            <div className='container-fluid' style={{ maxWidth: '1300px', marginTop: '180px', overflow: 'hidden' }}>
                <div className='col d-flex align-items-center mb-5'>
                    ...
                    <Link to={"/"} style={{ fontSize: '15px', textDecoration: 'none', color: '#888', marginLeft: '8px' }}>Tin tức</Link>  <br />
                </div>
                ...
                <div style={{ maxWidth: '100%', wordWrap: 'break-word' }}>
                    ...
                    <div style={{ width: '100%', height: '500px', display: 'flex', fontSize: '18px' }}>
                        ...
                        <div class="card" style={{ height: '450px', flex: '1', backgroundColor: 'rgba(217, 217, 217, 0.35)' }}>
                            <img src={require('../../../assets/img_TinTuc/tt2.png')} class="card-img-top" alt="..." style={{ objectFit: 'cover', width: '392px' }} />
                            <div style={{ display: 'flex', height: '50px' }}>
                                <img src={require('../../../assets/img_TinTuc/candela.png')} alt='' style={{ height: '35px', width: '35px', marginTop: '10px', marginLeft: '10px' }}></img>
                                <p style={{ marginTop: '15px' }}>15/03/2024</p>
                            </div>
                            <div class="card-body p-0 pe-3 ps-3">
                                <h5 class="card-title"><b>Sau Tết, thị trường lợn, gà giống ở Nghệ An sôi động</b></h5>
                                <p class="card-text mt-4">Sau Tết là thời điểm người chăn nuôi bước vào chu kỳ đầu tư mới của một năm, do đó, nhu cầu về con giống cũng gia tăng. </p>
                            </div>
                        </div>
                    </div>
                </div>
